...
if($otp=="123456")
{
    $bookid="BKID".rand(10,99);
    mysqli_query($con,"insert into tbl_bookings values(NULL,'$bookid','".$_SESSION['theatre']."','".$_SESSION['user']."','".$_SESSION['show']."','".$_SESSION['screen']."','".$_SESSION['seats']."','".$_SESSION['amount']."','$number','".$_SESSION['date']."',CURDATE(),'1')");
...
<script>
    setTimeout(function(){ window.location="profile.php"; }, 500);
</script>
